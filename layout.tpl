...
<head>
    ...
    {* Stylesheets *}
     {stylesheets file='assets/css/*.css'}  <!-- Nico remplace styles.css par *.css / charge toutes les css -->
        ...
        <div class="header">
            <h1 class="logo">
	            <a href="{navigate to="index"}" title="{$store_name}">
                    {images file='assets/img/logo.gif'}<img src="{$asset_url}" alt="{$store_name}" class="animated fadeIn">{/images}
                </a>
            </h1>
...
<main class="main-container" role="main">
    <div class="container">
        ...
        <div id="content">{block name="main-content"}{/block}</div> <!-- main-content defini dans brand.html -->
        
        <!-- le carousel est dans le hook choisi -->
